...
public class MpGenerate {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/ddmanager?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&zeroDateTimeBehavior=convertToNull");
        ...
        pc.setParent("ciih.dsg.xhj");//你哪个父目录下创建包
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/java/ciih/dsg/xhj/mapper/xml/"
